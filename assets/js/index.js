...
date_format = (str) => {
    var nd = new Date(str.replace(/-/g,'/')).toLocaleString('pt-BR', { year: 'numeric', month: '2-digit', day: '2-digit' }),
        day = ['Domingo', 'Segunda-feira', 'Terça-feira', 'Quarta-feira', 'Quinta-feira', 'Sexta-feira', 'Sábado'][nd.getDay()],
        date = nd.getDate(),
